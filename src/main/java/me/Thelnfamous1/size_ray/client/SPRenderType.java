...
public class SPRenderType extends RenderType {
    public final static ResourceLocation CORE_LOCATION = SizeRayMod.location("textures/entity/energy_beam/core.png");
    public final static ResourceLocation MAIN_LOCATION = SizeRayMod.location("textures/entity/energy_beam/main.png");
    public final static ResourceLocation GLOW_LOCATION = SizeRayMod.location("textures/entity/energy_beam/glow.png");
    // Dummy
